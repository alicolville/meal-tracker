...
jQuery( document ).ready( function( $ ) {
    ...
    function yk_mt_post_api_load_meal_callback( data, response ) {
        ...
        if ( false === response[ 'error' ] ) {
            ...
            // Is MacroN populated?
            if ( yk_mt_meal_tracker_found && 'true' === yk_mt_sc_meal_tracker[ 'macros-enabled' ] ) {
                $( '#yk-mt-add-meal-fats' ).val( meal[ 'fats' ] );
                $( '#yk-mt-add-meal-proteins' ).val( meal[ 'proteins' ] );
                $( '#yk-mt-add-meal-carbs' ).val( meal[ 'carbs' ] );
            }
     ...
     * @param unit
     */
    function yk_mt_post_api_edit_meal( name, description, calories, quantity, unit, macroN ) {
