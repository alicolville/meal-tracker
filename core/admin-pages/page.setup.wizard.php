			...
			<div id="post-body" class="metabox-holder columns-3">
				...
				<div id="post-body-content">
					...
					<div class="meta-box-sortables ui-sortable">
						...
						<div class="postbox">
							<h3 class="hndle"><span><?php echo esc_html__( 'Setup Wizard', YK_MT_SLUG ); ?> </span></h3>
							<div style="padding: 15px 15px 0px 15px">
                                <div id="yk-mt-tabs">
                                    <ul>
                                        <li><a>1. <?php echo esc_html__( 'Introduction', YK_MT_SLUG ); ?><span><?php echo esc_html__( 'Thank you for using Meal Tracker', YK_MT_SLUG ); ?></span></a></li>
                                        <li><a>2. <?php echo esc_html__( 'Setup', YK_MT_SLUG ); ?><span><?php echo esc_html__( 'How to use Shortcodes and Widgets', YK_MT_SLUG ); ?></span></a></li>
                                        <li><a>3. <?php echo esc_html__( 'Admin Interface', YK_MT_SLUG ); ?><span><?php echo esc_html__( 'Viewing and interacting with your user\'s data', YK_MT_SLUG ); ?></span></a></li>
                                        <li><a>4. <?php echo esc_html__( 'Customisations', YK_MT_SLUG ); ?><span><?php echo esc_html__( 'Custom modifications to Meal Tracker', YK_MT_SLUG ); ?></span></a></li>
                                    </ul>
                                    <div>
                                        <div>
                                            <h3>Thank you</h3>
                                        ...
                                        <div>
											...
											<a href="https://mealtracker.yeken.uk/shortcodes.html" rel="noopener noreferrer"  class="button"  target="_blank"><?php echo esc_html__( 'View Documentation', YK_MT_SLUG ); ?></a>
                                        </div>
                                        <div>
                                            <p>
											...
											<a href="https://mealtracker.yeken.uk/admin.html" rel="noopener noreferrer"  class="button"  target="_blank"><?php echo esc_html__( 'View Documentation', YK_MT_SLUG ); ?></a>
                                        </div>
                                        <div>
